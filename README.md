...
Simple neovim config, based on [nvim-basic-ide](https://github.com/LunarVim/nvim-basic-ide) with attempt to lazy-load most of plugins (startup time ~40ms on my machine)
...
**NOTE** Checkout this file for some predefined keymaps: [keymaps](https://github.com/hirotasoshu/.nvim/blob/master/lua/user/keymaps.lua)
...
Make sure the formatter or linter is installed and add it to this setup function: [null-ls](https://github.com/hirotasoshu/.nvim/blob/master/lua/user/lsp/null-ls.lua)

**NOTE** Some are already setup as examples, remove them if you want

### Plugins

You can install new plugins here: [plugins](https://github.com/hirotasoshu/.nvim/blob/master/lua/user/plugins.lua)

---

## Plugins
- [My vim-veno fork](https://github.com/hirotasoshu/vim-venom)
